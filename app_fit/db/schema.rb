...
ActiveRecord::Schema[8.0].define(version: 2025_11_18_090000) do
  ...
  create_table "challenges", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["scoring_rule_id"], name: "index_challenges_on_scoring_rule_id"
  ...
  create_table "leaderboards", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["challenge_id", "user_id"], name: "index_leaderboards_on_challenge_user_unique", unique: true
  ...
  add_foreign_key "challenges", "scoring_rules"
  ...
  add_foreign_key "scoring_rules", "users"
